...
international_position_filters = {
        ...
        'Japanese': {
            ...
            'DF (R)': ['DF (R)', 'DF (RL)', 'DF (RC)', 'DF (RLC)', 'DF/WB (R)', 'DF/WB (RL)',
                       'DF/WB/MF (R)', 'DF/WB/MF (RL)', 'DF/WB/MF/AM (R)', 'DF/WB/MF/AM (RL)',
                       'DF/WB/MF/AM (RC)', 'DF/WB/MF/AM (RLC)', 'DF/MF (R)', 'DF/MF (RL)'],
            'DF (L)': ['DF (L)', 'DF (RL)', 'DF (LC)', 'DF (RLC)', 'DF/WB (L)', 'DF/WB (RL)',
                       'DF/WB/MF (L)', 'DF/WB/MF (RL)', 'DF/WB/MF/AM (L)', 'DF/WB/MF/AM (RL)', 'DF/MF (L)', 'DF/MF (RL)'],
            'WB (R)': ['DF/WB (R)', 'DF/WB (RL)', 'DF/WB/MF (R)', 'DF/WB/MF (RL)', 'DF/WB/MF (RC)',
                       'DF/WB/MF (RLC)', 'DF/WB/MF/AM (R)', 'DF/WB/MF/AM (RL)', 'DF/WB/MF/AM (RC)',
                       'DF/WB/MF/AM (RLC)', 'WB (R)', 'WB (RL)', 'WB/MF (R)', 'WB/MF (RL)',
                       'WB/MF (RC)', 'WB/MF (RLC)', 'WB/MF/AM (R)', 'WB/MF/AM (RL)'],
            'WB (L)': ['DF/WB (L)', 'DF/WB (RL)', 'DF/WB/MF (L)', 'DF/WB/MF (RL)', 'DF/WB/MF (LC)',
                       'DF/WB/MF (RLC)', 'DF/WB/MF/AM (L)', 'DF/WB/MF/AM (RL)', 'DF/WB/MF/AM (LC)',
                       'DF/WB/MF/AM (RLC)', 'WB (L)', 'WB (RL)', 'WB/MF (L)', 'WB/MF (RL)',
                       'WB/MF (LC)', 'WB/MF (RLC)', 'WB/MF/AM (L)', 'WB/MF/AM (RL)'],
            'MF (R)': ['DF/WB/MF (R)', 'DF/WB/MF (RL)', 'DF/WB/MF (RC)', 'DF/WB/MF (RLC)', 'DF/WB/MF/AM (R)',
                       'DF/WB/MF/AM (RL)', 'DF/WB/MF/AM (RC)', 'DF/WB/MF/AM (RLC)', 'WB/MF (R)', 'WB/MF (RL)',
                       'WB/MF (RC)', 'WB/MF (RLC)', 'WB/MF/AM (R)', 'WB/MF/AM (RL)', 'WB/MF/AM (RC)',
                       'WB/MF/AM (RLC)', 'MF (R)', 'MF (RL)', 'MF (RC)', 'MF (RLC)', 'MF/AM (R)', 'MF/AM (RL)',
                       'MF/AM (RC)', 'MF/AM (RLC)'],
            'MF (L)': ['DF/WB/MF (L)', 'DF/WB/MF (RL)', 'DF/WB/MF (LC)', 'DF/WB/MF (RLC)', 'DF/WB/MF/AM (L)',
                       'DF/WB/MF/AM (RL)', 'DF/WB/MF/AM (LC)', 'DF/WB/MF/AM (RLC)', 'WB/MF (L)', 'WB/MF (RL)',
                       'WB/MF (LC)', 'WB/MF (RLC)', 'WB/MF/AM (L)', 'WB/MF/AM (RL)', 'WB/MF/AM (LC)',
                       'WB/MF/AM (RLC)', 'MF (L)', 'MF (RL)', 'MF (LC)', 'MF (RLC)', 'MF/AM (L)', 'MF/AM (RL)',
                       'MF/AM (LC)', 'MF/AM (RLC)'],
            'DM': ['DM'],
            'MF (C)': ['MF (C)', 'MF (RC)', 'MF (LC)', 'MF (RLC)', 'MF/AM (C)', 'MF/AM (RC)', 'MF/AM (LC)', 'MF/AM (RLC)'],
            'AM (C)': ['MF/AM (C)', 'MF/AM (RC)', 'MF/AM (LC)', 'MF/AM (RLC)',
                       'AM (C)', 'AM (RC)', 'AM (LC)', 'AM (RLC)'],
            'AM (R)': ['D/WB/MF/AM (R)', 'D/WB/MF/AM (RL)', 'D/WB/MF/AM (RC)', 'D/WB/MF/AM (RLC)',
                       'WB/MF/AM (R)', 'WB/MF/AM (RL)', 'WB/MF/AM (RC)', 'WB/MF/AM (RLC)',
                       'MF/AM (R)', 'MF/AM (RL)', 'MF/AM (RC)', 'MF/AM (RLC)',
                       'AM (R)', 'AM (RL)', 'AM (RC)', 'AM (RLC)'],
            'AM (L)': ['D/WB/MF/AM (L)', 'D/WB/MF/AM (RL)', 'D/WB/MF/AM (LC)', 'D/WB/MF/AM (RLC)',
        ...
        'Greek': {
            'TΦ': ['TΦ'],
            'A (K)': ['A (K)', 'A (ΔK)', 'A (AK)', 'A (ΔAK)'],
            'A (Δ)': ['A (Δ)', 'A (ΔA)', 'A (ΔK)', 'A (ΔAK)', 'A/MX (Δ)', 'A/MX (ΔA)',
                      'A/MX/M (Δ)', 'A/MX/M (ΔA)', 'A/MX/M/EM (Δ)', 'A/MX/M/EM (ΔA)',
                      'A/MX/M/EM (ΔK)', 'A/MX/M/EM (ΔAK)', 'A/M (Δ)', 'A/M (ΔA)'],
            'A (A)': ['A (A)', 'A (ΔA)', 'A (AK)', 'A (ΔAK)', 'A/MX (A)', 'A/MX (ΔA)',
                      'A/MX/M (A)', 'A/MX/M (ΔA)', 'A/MX/M/EM (A)', 'A/MX/M/EM (ΔA)', 'A/M (A)', 'A/M (ΔA)'],
            'MX (Δ)': ['A/MX (Δ)', 'A/MX (ΔA)', 'A/MX/M (Δ)', 'A/MX/M (ΔA)', 'A/MX/M (ΔK)',
                       'A/MX/M (ΔAK)', 'A/MX/M/EM (Δ)', 'A/MX/M/EM (ΔA)', 'A/MX/M/EM (ΔK)',
                       'A/MX/M/EM (ΔAK)', 'MX (Δ)', 'MX (ΔA)', 'MX/M (Δ)', 'MX/M (ΔA)',
                       'MX/M (ΔK)', 'MX/M (ΔAK)', 'MX/M/EM (Δ)', 'MX/M/EM (ΔA)'],
            'MX (A)': ['A/MX (A)', 'A/MX (ΔA)', 'A/MX/M (A)', 'A/MX/M (ΔA)', 'A/MX/M (AK)',
                       'A/MX/M (ΔAK)', 'A/MX/M/EM (A)', 'A/MX/M/EM (ΔA)', 'A/MX/M/EM (AK)',
                       'A/MX/M/EM (ΔAK)', 'MX (A)', 'MX (ΔA)', 'MX/M (A)', 'MX/M (ΔA)',
                       'MX/M (AK)', 'MX/M (ΔAK)', 'MX/M/EM (A)', 'MX/M/EM (ΔA)'],
            'M (Δ)': ['A/MX/M (Δ)', 'A/MX/M (ΔA)', 'A/MX/M (ΔK)', 'A/MX/M (ΔAK)', 'A/MX/M/EM (Δ)',
                      'A/MX/M/EM (ΔA)', 'A/MX/M/EM (ΔK)', 'A/MX/M/EM (ΔAK)', 'MX/M (Δ)', 'MX/M (ΔA)',
                      'MX/M (ΔK)', 'MX/M (ΔAK)', 'MX/M/EM (Δ)', 'MX/M/EM (ΔA)', 'MX/M/EM (ΔK)',
                      'MX/M/EM (ΔAK)', 'M (Δ)', 'M (ΔA)', 'M (ΔK)', 'M (ΔAK)', 'M/EM (Δ)', 'M/EM (ΔA)',
                      'M/EM (ΔK)', 'M/EM (ΔAK)'],
            'M (A)': ['A/MX/M (A)', 'A/MX/M (ΔA)', 'A/MX/M (AK)', 'A/MX/M (ΔAK)', 'A/MX/M/EM (A)',
                      'A/MX/M/EM (ΔA)', 'A/MX/M/EM (AK)', 'A/MX/M/EM (ΔAK)', 'MX/M (A)', 'MX/M (ΔA)',
                      'MX/M (AK)', 'MX/M (ΔAK)', 'MX/M/EM (A)', 'MX/M/EM (ΔA)', 'MX/M/EM (AK)',
                      'MX/M/EM (ΔAK)', 'M (A)', 'M (ΔA)', 'M (AK)', 'M (ΔAK)', 'M/EM (A)', 'M/EM (ΔA)',
                      'M/EM (AK)', 'M/EM (ΔAK)'],
            'DM': ['DM'],
            'M (K)': ['M (K)', 'M (ΔK)', 'M (AK)', 'M (ΔAK)', 'M/EM (K)', 'M/EM (ΔK)', 'M/EM (AK)', 'M/EM (ΔAK)'],
            'EM (K)': ['M/EM (K)', 'M/EM (ΔK)', 'M/EM (AK)', 'M/EM (ΔAK)',
                       'EM (K)', 'EM (ΔK)', 'EM (AK)', 'EM (ΔAK)'],
            'EM (Δ)': ['D/MX/M/EM (Δ)', 'D/MX/M/EM (ΔA)', 'D/MX/M/EM (ΔK)', 'D/MX/M/EM (ΔAK)',
                       'MX/M/EM (Δ)', 'MX/M/EM (ΔA)', 'MX/M/EM (ΔK)', 'MX/M/EM (ΔAK)',
                       'M/EM (Δ)', 'M/EM (ΔA)', 'M/EM (ΔK)', 'M/EM (ΔAK)',
                       'EM (Δ)', 'EM (ΔA)', 'EM (ΔK)', 'EM (ΔAK)'],
            'EM (A)': ['D/MX/M/EM (A)', 'D/MX/M/EM (ΔA)', 'D/MX/M/EM (AK)', 'D/MX/M/EM (ΔAK)',
                       'MX/M/EM (A)', 'MX/M/EM (ΔA)', 'MX/M/EM (AK)', 'MX/M/EM (ΔAK)',
                       'M/EM (A)', 'M/EM (ΔA)', 'M/EM (AK)', 'M/EM (ΔAK)',
                       'EM (A)', 'EM (ΔA)', 'EM (AK)', 'EM (ΔAK)'],
            'EΠ': ['EΠ (K)']
        },
        'Russian': {
            'В': ['В'],
